...
export interface Recording { session_id: string; session_name: string; session_description: string; status: string; created_at: string; duration_seconds: number; size_bytes: number; briefcase_link?: string; command_log_link?: string; delivery_error?: string }
