...
silicon-browser open https://app.slack.com
```
...
silicon-browser click @e21  # Ref for "More unreads" button
silicon-browser screenshot slack-unreads.png
```
...
silicon-browser click @e14  # Activity tab (ref may vary)
silicon-browser wait 1000
silicon-browser screenshot activity-unreads.png

# Or check DMs tab
silicon-browser click @e13  # DMs tab
silicon-browser screenshot dms.png

# Or expand "More unreads" in sidebar
silicon-browser click @e21  # More unreads button
silicon-browser wait 500
silicon-browser screenshot expanded-unreads.png
```
...
silicon-browser click @e94  # Example: engineering channel ref
silicon-browser wait --load networkidle
silicon-browser screenshot channel.png
```
...
# Use Slack search
silicon-browser snapshot -i
silicon-browser click @e5  # Search button (typical ref)
silicon-browser fill @e_search "keyword"
...
silicon-browser snapshot --json > slack-snapshot.json
...
silicon-browser snapshot -i
silicon-browser screenshot channel-details.png

# Scroll through messages
silicon-browser scroll down 500
silicon-browser screenshot channel-messages.png
```
...
silicon-browser screenshot --annotate slack-state.png

# Take full-page screenshot
silicon-browser screenshot --full slack-full.png
...
silicon-browser get text @e_message_ref
```
...
silicon-browser snapshot --json > output.json
...
silicon-browser snapshot -i | grep -c "treeitem"
# Each treeitem with a channel name in the unreads section is one unread
```

## Best Practices

- **Connect to existing sessions**: Use `silicon-browser connect 9222` if Slack is already open. This is faster than opening a new browser.
...
- **Scroll in sidebar**: Use `silicon-browser scroll down 300 --selector ".p-sidebar"` to scroll within the Slack sidebar if channel list is long.
...
silicon-browser get url
silicon-browser get title
silicon-browser screenshot page-state.png
```
...
silicon-browser snapshot -i > snapshot.txt

# Check Activity tab for unreads
silicon-browser click @e14  # Activity tab
silicon-browser wait 1000
silicon-browser screenshot activity.png
ACTIVITY_RESULT=$(silicon-browser get text @e_main_area)
...
silicon-browser click @e21  # More unreads button
silicon-browser wait 500
silicon-browser snapshot -i > unreads-expanded.txt
silicon-browser screenshot unreads.png
