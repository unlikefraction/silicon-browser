...
```bash
silicon-browser profiler start
silicon-browser navigate https://app.example.com
silicon-browser wait --load networkidle
silicon-browser profiler stop ./page-load-profile.json
```
...
silicon-browser profiler stop ./interaction-profile.json
```
...
silicon-browser navigate https://app.example.com
silicon-browser wait --load networkidle
silicon-browser profiler stop "./profiles/build-${BUILD_ID}.json"
```
