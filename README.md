...
sb --test <environment-uuid> --org-id tos login worker:tos
...
`sb testing login` also reads `SB_TEST_APP_SECRET`. The app secret alone selects
...
```sh
SB_TEST_BACKEND=http://127.0.0.1:8080 SB_TEST_CLI="$PWD/target/debug/sb" \
