...
//! `SILICON_BROWSER_COLOR=1`. Setting `NO_COLOR` to any value disables
...
/// `SILICON_BROWSER_COLOR` (truthy enables) > default (off).
pub fn is_enabled() -> bool {
    ...
    *COLORS_ENABLED.get_or_init(|| {
        ...
        env_is_truthy("SILICON_BROWSER_COLOR").unwrap_or(false)
    })
}
