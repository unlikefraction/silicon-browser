...
silicon-browser --cdp "ws://localhost:9222/devtools/browser/abc123" open example.com
```
...
silicon-browser --auto-connect open example.com
silicon-browser --auto-connect snapshot

# Or via environment variable
SILICON_BROWSER_AUTO_CONNECT=1 silicon-browser snapshot
```
...
```bash
silicon-browser --cdp 9222 --color-scheme dark open https://example.com
silicon-browser --cdp 9222 snapshot  # stays in dark mode
```

Or set it globally via config or environment variable:

```bash
SILICON_BROWSER_COLOR_SCHEME=dark silicon-browser --cdp 9222 open https://example.com
```
