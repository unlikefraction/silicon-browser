...
silicon-browser snapshot -c                 # Compact (remove empty elements)
silicon-browser snapshot -d 3               # Limit depth to 3 levels
silicon-browser snapshot -s "#main"         # Scope to CSS selector
silicon-browser snapshot -i -c -d 5         # Combine options
```
...
```bash
silicon-browser click @e2      # Click the Submit button
silicon-browser fill @e3 "a@b.com"  # Fill the email input
...
```bash
silicon-browser click @e4      # Navigates to new page
silicon-browser snapshot -i    # Get fresh refs
...
```bash
silicon-browser screenshot --annotate ./page.png
...
silicon-browser fill @e3 "4111111111111111"
silicon-browser click @e4
```
